...
SA_LOG_BATCH_EVERY = 0
SA_FLOW_DIAG_EVERY_EPOCHS = 1
SA_MONITOR_METRICS_EVERY_EPOCHS = 5
SA_MONITOR_MAX_SAMPLES = 5000
SA_MONITOR_DO_COVERAGE = False
SA_MONITOR_COVERAGE_MAX_SAMPLES = 2000
SA_MIN_R_EPS = 1e-6
...
SA_NODE2VEC_Q = 1.0
SA_GFUNC_TOPK = 100
SA_PHYS_EDGES_CSV = "data/topology/sa_phys_edges_S1.csv"
